    ...
    <section className="relative min-h-[min(820px,100vh)] overflow-hidden bg-[var(--background)] px-0 pb-[82px] pt-[120px] max-[900px]:pb-[130px] max-[640px]:pt-[105px]" id="home">
      ...
      <div className="relative mx-auto grid min-h-[535px] w-full max-w-[1280px] grid-cols-[1.05fr_.95fr] px-8 max-[900px]:grid-cols-1 max-[640px]:px-5">
        <div className="relative z-[1] max-w-[760px] self-center">
          ...
          <p className="animate-fade-up my-[30px] mb-[34px] max-w-[440px] text-base leading-[1.6] text-[var(--muted)] [animation-delay:180ms]">Smart Tech Guide combines UI/UX, web design, development and graphic design to make digital work with clarity and character.</p>
        ...
        <div className="relative h-[490px] self-center max-[900px]:mt-[55px] max-[900px]:h-[410px] max-[640px]:mt-[38px] max-[640px]:h-[330px]" aria-label="Abstract composition of design and technology" role="img">
          ...
          <div className="absolute left-[18%] top-[92px] h-[300px] w-[370px] -rotate-[7deg] bg-[var(--dark)] p-5 text-[var(--surface)] shadow-[14px_17px_0_var(--coral)] max-[640px]:left-[8%] max-[640px]:top-[55px] max-[640px]:h-[220px] max-[640px]:w-[275px] max-[640px]:p-3.5">
            ...
            <div className="my-[42px] flex items-center gap-4 max-[640px]:my-[28px] max-[640px]:gap-2.5"><Image className="h-[92px] w-[92px] object-contain max-[640px]:h-[62px] max-[640px]:w-[62px]" src="/logo-symbol.png" alt="Smart Tech Guide symbol" width={404} height={416} /><div className="h-[92px] min-w-0 flex-1 opacity-75 [background-image:linear-gradient(to_right,rgba(16,191,170,.7)_1px,transparent_1px),linear-gradient(to_bottom,rgba(16,191,170,.7)_1px,transparent_1px)] [background-size:18px_18px] [mask-image:linear-gradient(to_bottom,transparent,black_18%,black_82%,transparent)] max-[640px]:h-[62px] max-[640px]:[background-size:13px_13px]" aria-hidden="true" /></div>
